...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
   ...
   <h1 align=center>------------------ Top Categories to choose from ---------------</h1>
        ...
        <asp:DataList ID="DataList1" runat="server" RepeatColumns="4" Width="100%" RepeatDirection="Horizontal" BackColor="#CCCCCC" BorderColor="Blue" BorderStyle="Ridge" BorderWidth="0px" CellPadding="4" CellSpacing="2" ForeColor="Black" GridLines="Both">
